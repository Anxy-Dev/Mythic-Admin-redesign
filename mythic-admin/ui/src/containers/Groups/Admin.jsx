                ...
                <Grid item xs={9} className={classes.wrapper}>
                    <div className={classes.content}>
                        <Switch>
							...
							<Route exact path="/ban-management" component={BanManagement} />
							<Route exact path="/server-logs" component={ServerLogs} />
							<Route exact path="/teleport-locations" component={TeleportLocations} />
							<Route exact path="/chat-logs" component={ChatLogs} />
