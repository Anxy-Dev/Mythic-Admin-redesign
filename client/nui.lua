...
RegisterNUICallback('GetCurrentCoordinates', function(data, cb)
...
RegisterNUICallback('GetTeleportLocations', function(data, cb)
    Callbacks:ServerCallback('Admin:GetTeleportLocations', data, cb)
end)

RegisterNUICallback('TeleportToLocation', function(data, cb)
    Callbacks:ServerCallback('Admin:TeleportToLocation', data, cb)
end)

RegisterNUICallback('AddTeleportLocation', function(data, cb)
    Callbacks:ServerCallback('Admin:AddTeleportLocation', data, cb)
end)

RegisterNUICallback('DeleteTeleportLocation', function(data, cb)
    Callbacks:ServerCallback('Admin:DeleteTeleportLocation', data, cb)
end)

RegisterNUICallback('GetChatLogs', function(data, cb)
    Callbacks:ServerCallback('Admin:GetChatLogs', data, cb)
end)

RegisterNUICallback('ToggleNoClip', function(data, cb)
    Callbacks:ServerCallback('Admin:ToggleNoClip', data, cb)
end)

RegisterNUICallback('ToggleGodMode', function(data, cb)
    Callbacks:ServerCallback('Admin:ToggleGodMode', data, cb)
end)

RegisterNUICallback('ToggleSuperJump', function(data, cb)
    Callbacks:ServerCallback('Admin:ToggleSuperJump', data, cb)
end)

RegisterNUICallback('ToggleFastRun', function(data, cb)
    Callbacks:ServerCallback('Admin:ToggleFastRun', data, cb)
end)
